#!/usr/bin/env node
/**
 * tests/qa_edward_exe_103.mjs — QA Edward 独立便携版验证（1.0.3）v2
...
const SRC_EXE = 'C:/Users/liao9/WorkBuddy/我的工作1/nms-power-sim-desktop/dist/无人深空电力模拟器-1.0.3-portable.exe';
const TMP_DIR = 'C:/Users/liao9/AppData/Local/Temp/QA 便携验证 103';
const EXE = path.join(TMP_DIR, '无人深空电力模拟器-1.0.3-portable.exe');
